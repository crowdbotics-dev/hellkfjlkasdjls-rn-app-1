...
## Project Structure
    ...
    ├── hellkfjlkasdjls_rn_app_1  # Django project configurations
...
1. Clone this repo and `cd hellkfjlkasdjls_rn_app_1`
...
2. Clone this repo and `cd hellkfjlkasdjls_rn_app_1`
